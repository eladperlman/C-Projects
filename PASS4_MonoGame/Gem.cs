...
//Description: Handles all the logic and graphics relating to a gem game object 
using System;
...
namespace PASS4_MonoGame
{
    class Gem : GameObject
    {
        ...
        //Post: N/A
        //Description: Calls the gameobject's constructor with gem image and its position
        public Gem(int x, int y) : base(MainGame.gameObjectsImg[MainGame.GEM], x, y)
        {
        }
