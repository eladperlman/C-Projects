...
//Description: Handles all the logic and graphics relating to a spike game object 
using System;
...
namespace PASS4_MonoGame
{
    class Spikes : GameObject
    {
        ...
        //Post: N/A
        //Description: Calls the gameobject's constructor with spikes image and its position
        public Spikes(int x, int y) : base(MainGame.gameObjectsImg[MainGame.SPIKES], x, y)
        {
